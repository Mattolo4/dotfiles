...
alias pro29='ssh pal@tiago-pro-29c -y'
alias pro43='ssh pal@tiago-pro-43c -y'
alias pro46='ssh pal@tiago-pro-46c -y'
alias jet43='ssh pal@172.25.43.11'
...
alias rvdp='rviz2 -d ~/exchange/mvi_dp.rviz'
...
alias ng='ros2 run rqt_graph rqt_graph  --force-discover'
alias tl='ros2 topic list | grep '
alias te='ros2 topic echo '
alias th='ros2 topic hz '
...
alias home='ros2 run play_motion2 run_motion home'
...
# RoboPlan 
alias cbrp='colcon build --build-base build_humble  --install-base install_humble --symlink-install --mixin compile-commands'
alias csrp='source install_humble/setup.bash'